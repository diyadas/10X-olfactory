...
message(paste(grep("Crispld2", de_onevall$Feature), collapse = ", "))
message(paste(de_onevall$ContrastName[c(15, 6458, 12361, 16397, 32221, 58980)], collapse = ", "))
crispld2ones<-c("Cl01", "Cl03", "Cl05","Cl07", "Cl22", "Cl45")
