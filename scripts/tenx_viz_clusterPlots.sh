...
R_LIBS=/share/groups/diya-russell/rpack/3.5/ R --vanilla < tenx_viz_clusterPlots.R --args --expt ob --ncores $ncores --norm $2 --method scone --markerfile "OBmarkers.txt" > 'tenx_viz_clusterPlots'$NOW'.Rout'
