...
#R_LIBS=/share/groups/diya-russell/rpack/3.5/ R --vanilla < tenx_viz_clusterPlots.R --args --expt regen --ncores $ncores --norm "none,fq,ruv_k=2,no_bio,no_batch" --method scone > 'tenx_viz_clusterPlots'$NOW'.Rout' 2>&1
