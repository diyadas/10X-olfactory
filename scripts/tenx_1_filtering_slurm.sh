...
LOG="logs/${expt}_1_filtering_slurm_${job}_${NOW}.Rout"
...
usage() {
       echo "usage: tenx_1_filtering_slurm.sh ncores" >&2
       exit 2
}

[[ $# -eq 1 ]] || usage  # fail if incorrect number of args and print usage info

while true; do free -h >> 'memorylogs/tenx_1_filtering_slurm_'$NOW'_memory.out'; sleep 15; done &
